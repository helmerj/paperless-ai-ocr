...
Ein intelligentes Python-Skript, das Dokumente aus Paperless-ngx extrahiert, mittels lokalem LLM (Ollama) verarbeitet und die Texte sowie die Dateien aktualisiert.

## ✨ Features
- **Unendliche Pagination:** Verarbeitet tausende Dokumente (2000+) ohne Unterbrechung.
...
- **Intelligentes Caching:** Verhindert redundante Downloads und schont Ressourcen.
...
```bash
# Repository klonen
git clone [https://github.com/dein-username/paperless-ai-ocr.git](https://github.com/dein-username/paperless-ai-ocr.git)
cd paperless-ai-ocr
